...
/**
 * Espejo de `ubicaciones.html`. Si allí cambian las columnas, aquí también: un esqueleto que
 * ya no coincide con lo que carga es peor que no tener ninguno.
 */
@Component({
  selector: 'app-ubicaciones-esqueleto',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './esqueleto.html',
})
export class UbicacionesEsqueleto {
